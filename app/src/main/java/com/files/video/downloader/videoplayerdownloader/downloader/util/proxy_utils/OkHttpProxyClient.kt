package com.files.video.downloader.videoplayerdownloader.downloader.util.proxy_utils
...
class OkHttpProxyClient @Inject constructor(
    ...
    private var currentProxy: com.files.video.downloader.videoplayerdownloader.downloader.model.Proxy
    ...
    fun getProxyOkHttpClient(): OkHttpClient {
        ...
        if (proxy.host != currentProxy.host && proxy.port != currentProxy.port || (httpClientCached == null)) {
            ...
            httpClientCached =
                if (proxy == com.files.video.downloader.videoplayerdownloader.downloader.model.Proxy.noProxy()) {
    ...
    private fun getProxy(): com.files.video.downloader.videoplayerdownloader.downloader.model.Proxy {
